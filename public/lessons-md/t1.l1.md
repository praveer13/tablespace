...
**Browser lab: Page Surgery** — Operate an 8KB slotted page with your hands: insert, delete, defrag — byte-exact or bust. (interactive, on the lesson page: https://tablespace.play.naigap.com/lesson/<this-lesson>)
